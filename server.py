...
if not Debug:
  ...
  server.server_roles = {"visitor":675870214314917927, "events":763868902077366373, "politics":858728241749032980, "gura":858727545146441739} # K=role name, V=[role ids list or singular]
